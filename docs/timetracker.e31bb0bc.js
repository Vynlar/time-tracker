...
var author$project$Main$makeTime = F2(
	function (hours, minutes) {
		return author$project$Main$Time((hours * 60) + minutes);
	});
	...
	return _Utils_Tuple2(
		{
			...
			log: _List_fromArray(
				[
					A2(
					author$project$Main$In,
					A2(author$project$Main$makeTime, 9, 0),
					'GBC-10'),
					A2(
					author$project$Main$In,
					A2(author$project$Main$makeTime, 9, 15),
					'GBC-457'),
					author$project$Main$Out(
					A2(author$project$Main$makeTime, 12, 5)),
					author$project$Main$Out(
					A2(author$project$Main$makeTime, 12, 20)),
					A2(
					author$project$Main$In,
					A2(author$project$Main$makeTime, 13, 0),
					'GBC-457'),
					A2(
					author$project$Main$In,
					A2(author$project$Main$makeTime, 13, 45),
					'GBC-342'),
					A2(
					author$project$Main$In,
					A2(author$project$Main$makeTime, 17, 45),
					'MD-120'),
					author$project$Main$Out(
					A2(author$project$Main$makeTime, 18, 5))
				]),
			timeInput: '',
...
var author$project$Main$ChangeTimeInput = function (a) {
	return {$: 'ChangeTimeInput', a: a};
};
var author$project$Main$CreateWithTime = F2(
	function (a, b) {
		return {$: 'CreateWithTime', a: a, b: b};
	});
...
var author$project$Main$parseTime = A2(
	...
	A2(
		elm$parser$Parser$keeper,
		elm$parser$Parser$succeed(author$project$Main$makeTime),
		A2(
...
var author$project$Main$posixToTime = F2(
	function (zone, posix) {
...
var author$project$Main$createEntry = F2(
	function (issue, model) {
		var timeResult = A2(elm$parser$Parser$run, author$project$Main$parseTime, model.timeInput);
		if (timeResult.$ === 'Ok') {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						...
						log: A2(
							elm$core$List$cons,
							A2(author$project$Main$In, time, issue),
							model.log),
						timeInput: ''
					}),
			...
			return _Utils_Tuple2(
				...
				A2(
					...
					A2(
						...
						author$project$Main$CreateWithTime(issue),
						author$project$Main$posixToTime(model.timeZone)),
					elm$time$Time$now));
		}
	});
...
var author$project$Main$posixToString = F2(
	function (zone, posix) {
		var minutes = A2(elm$time$Time$toMinute, zone, posix);
		var hours = A2(elm$time$Time$toHour, zone, posix);
		...
		switch (msg.$) {
			...
			case 'SetTimezone':
				...
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$none);
			case 'CreateEntry':
				return A2(author$project$Main$createEntry, model.issue, model);
			case 'CreateWithTime':
				var issue = msg.a;
				var time = msg.b;
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$none);
			case 'CreateEntryWithIssue':
				var issue = msg.a;
				return A2(author$project$Main$createEntry, issue, model);
			default:
				return _Utils_Tuple2(
					model,
					A2(
						elm$core$Task$perform,
						function (posix) {
							return author$project$Main$ChangeTimeInput(
								A2(author$project$Main$posixToString, model.timeZone, posix));
						},
						elm$time$Time$now));
		}
	});
var author$project$Main$ChangeIssue = function (a) {
	return {$: 'ChangeIssue', a: a};
};
var author$project$Main$CreateEntry = {$: 'CreateEntry'};
var author$project$Main$NowPressed = {$: 'NowPressed'};
...
var author$project$Main$blue = A3(mdgriffith$elm_ui$Element$rgb255, 51, 140, 229);
var author$project$Main$getIssue = function (entry) {
	if (entry.$ === 'In') {
		var issue = entry.b;
		return elm$core$Maybe$Just(issue);
	} else {
		return elm$core$Maybe$Nothing;
	}
};
var author$project$Main$getTime = function (entry) {
	if (entry.$ === 'In') {
		var time = entry.a;
		return time;
	} else {
...
var author$project$Main$calculateTotals = function (log) {
	return A2(
		elm$core$List$map,
		function (_n2) {
			var first = _n2.a;
			var second = _n2.b;
			var secondTime = author$project$Main$getTime(second);
			var issue = A2(
				elm$core$Maybe$withDefault,
				'',
				author$project$Main$getIssue(first));
			var firstTime = author$project$Main$getTime(first);
			var duration = function () {
				var _n3 = _Utils_Tuple2(firstTime, secondTime);
				var a = _n3.a.a;
				var b = _n3.b.a;
				return b - a;
			}();
			return _Utils_Tuple2(issue, duration);
		},
		A2(
	...
	return A2(
		...
		A2(
			...
			A2(
				...
				_List_fromArray(
					[
						_Utils_Tuple2(hours, 'h'),
						_Utils_Tuple2(minutes, 'm')
					]))));
};
...
var author$project$Main$getAllIssues = function (log) {
		...
		elm$core$Set$fromList(
			A2(
				...
				A2(
					...
					A2(elm$core$List$map, author$project$Main$getIssue, log)))));
};
var author$project$Main$lightBlue = A3(mdgriffith$elm_ui$Element$rgb255, 228, 241, 255);
...
var author$project$Main$normalShadow = function (size) {
	return mdgriffith$elm_ui$Element$Border$shadow(
		{
			blur: size,
			color: A4(mdgriffith$elm_ui$Element$rgba, 0, 0, 0, 0.15),
			offset: _Utils_Tuple2(0.0, size),
			size: 0
		});
};
var author$project$Main$segmentToString = function (segment) {
	if (segment.$ === 'AM') {
		return 'AM';
	} else {
		return 'PM';
...
var author$project$Main$timeToHours = function (time) {
	var minutes = time.a;
	var hours = A2(elm$core$Basics$modBy, 12, (minutes / 60) | 0);
	return (!hours) ? 12 : hours;
};
var author$project$Main$timeToMinutes = function (time) {
	var minutes = time.a;
	return A2(elm$core$Basics$modBy, 60, minutes);
};
var author$project$Main$AM = {$: 'AM'};
var author$project$Main$PM = {$: 'PM'};
var author$project$Main$timeToTotalHours = function (time) {
	var minutes = time.a;
	return (minutes / 60) | 0;
};
var author$project$Main$timeToSegment = function (time) {
	var hours = author$project$Main$timeToTotalHours(time);
	return (hours < 12) ? author$project$Main$AM : author$project$Main$PM;
};
var author$project$Main$timeToString = function (time) {
	return elm$core$String$fromInt(
		author$project$Main$timeToHours(time)) + (':' + (A3(
		elm$core$String$padLeft,
		2,
		_Utils_chr('0'),
		elm$core$String$fromInt(
			author$project$Main$timeToMinutes(time))) + (' ' + author$project$Main$segmentToString(
		author$project$Main$timeToSegment(time)))));
};
...
var author$project$Main$renderEntry = F2(
	function (zone, entry) {
		var _n0 = author$project$Main$getIssue(entry);
		if (_n0.$ === 'Nothing') {
			return A2(
					...
					[
						...
						mdgriffith$elm_ui$Element$text(
							author$project$Main$timeToString(
								author$project$Main$getTime(entry))))
					]));
		} else {
			var issue = _n0.a;
			return A2(
				...
				_List_fromArray(
					[
						...
						author$project$Main$normalShadow(3),
				...
				_List_fromArray(
					[
						...
						A2(
							elm$core$Maybe$withDefault,
							'Out',
							author$project$Main$getIssue(entry))),
						A2(
						mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
...
var author$project$Main$CreateEntryWithIssue = function (a) {
	return {$: 'CreateEntryWithIssue', a: a};
};
...
var author$project$Main$renderQuickButton = function (issue) {
	return A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
		...
		A2(
			...
			{
				label: mdgriffith$elm_ui$Element$text(issue),
				onPress: elm$core$Maybe$Just(
					author$project$Main$CreateEntryWithIssue(issue))
			}));
};
...
var author$project$Main$timeToTotalMinutes = function (time) {
	var minutes = time.a;
	return minutes;
};
var elm$core$List$sortBy = _List_sortBy;
var author$project$Main$sortLog = function (log) {
	return A2(
		elm$core$List$sortBy,
		A2(elm$core$Basics$composeL, author$project$Main$timeToTotalMinutes, author$project$Main$getTime),
		log);
};
				...
				A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									author$project$Main$renderTitle('Log'),
									A2(
									mdgriffith$elm_ui$Element$row,
									_List_fromArray(
										[
									...
									_List_fromArray(
										[
												...
												]),
											{
												...
												onChange: author$project$Main$ChangeTimeInput,
												placeholder: elm$core$Maybe$Just(
													A2(
														mdgriffith$elm_ui$Element$Input$placeholder,
														_List_Nil,
														mdgriffith$elm_ui$Element$text('hh:mm'))),
												...
												]),
											{
												...
												onPress: elm$core$Maybe$Just(author$project$Main$NowPressed)
											})
										])),
									A2(
									mdgriffith$elm_ui$Element$column,
									...
									_List_fromArray(
										[
												...
												]),
											{
												...
												onChange: author$project$Main$ChangeIssue,
												placeholder: elm$core$Maybe$Just(
													A2(
														mdgriffith$elm_ui$Element$Input$placeholder,
														_List_Nil,
														mdgriffith$elm_ui$Element$text('ex. GBC-10, standup'))),
												text: model.issue
											}),
											A2(
											...
											A2(
												elm$core$List$map,
												author$project$Main$renderQuickButton,
												author$project$Main$getAllIssues(model.log)))
										])),
									A2(
									mdgriffith$elm_ui$Element$Input$button,
									_List_fromArray(
										...
										]),
									{
										...
										onPress: elm$core$Maybe$Just(author$project$Main$CreateEntry)
									})
								])),
							A2(
							mdgriffith$elm_ui$Element$column,
							...
							_Utils_ap(
								_List_fromArray(
									[
										author$project$Main$renderTitle('Entries')
									]),
								A2(
									elm$core$List$map,
									author$project$Main$renderEntry(model.timeZone),
									author$project$Main$sortLog(model.log)))),
							A2(
							mdgriffith$elm_ui$Element$column,
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									...
									_Utils_ap(
										_List_fromArray(
											[
												author$project$Main$renderTitle('Summary')
											]),
										A2(
											elm$core$List$map,
											function (_n0) {
											...
											author$project$Main$calculateTotals(model.log))))
								]))
						])))
			]),
		title: 'Timetracker'
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(
		{}))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Main.Issue":{"args":[],"type":"String.String"},"Main.Minutes":{"args":[],"type":"Basics.Int"},"Time.Era":{"args":[],"type":"{ start : Basics.Int, offset : Basics.Int }"}},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"SetTimezone":["Time.Zone"],"CreateEntry":[],"CreateEntryWithIssue":["Main.Issue"],"CreateWithTime":["Main.Issue","Main.Time"],"ChangeIssue":["String.String"],"ChangeTimeInput":["String.String"],"NowPressed":[]}},"Main.Time":{"args":[],"tags":{"Time":["Main.Minutes"]}},"String.String":{"args":[],"tags":{"String":[]}},"Time.Zone":{"args":[],"tags":{"Zone":["Basics.Int","List.List Time.Era"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}}}}})}});
...
//# sourceMappingURL=/timetracker.e31bb0bc.map